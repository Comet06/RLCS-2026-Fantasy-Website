...
window.addEventListener('load', function() {
  if (window.location.pathname === '/RLCS-2026-Fantasy-League/index.html') {
    console.log('The specific page has loaded!');
    deployScores()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/regional_1.html') {
    console.log('The specific page has loaded!');
    deployReg1()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/regional_2.html') {
    console.log('The specific page has loaded!');
    deployReg2()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/regional_3.html') {
    console.log('The specific page has loaded!');
    deployReg3()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/major_1.html') {
    console.log('The specific page has loaded!');
    deployMaj1()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/regional_4.html') {
    console.log('The specific page has loaded!');
    deployReg4()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/regional_5.html') {
    console.log('The specific page has loaded!');
    deployReg5()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/regional_6.html') {
    console.log('The specific page has loaded!');
    deployReg6()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/major_2.html') {
    console.log('The specific page has loaded!');
    deployMaj2()
  } else if (window.location.pathname === '/RLCS-2026-Fantasy-League/championship.html') {
    console.log('The specific page has loaded!');
    deployChamp()
  } else {
